...
type ElementType = "single_choice" | "multiple_choice" | "text_input" | "number_input" | "file_upload";
    ...
    <div className="fixed inset-0 bg-black/70 z-[60] flex items-center justify-end" onClick={onClose}>
      ...
      >
        <div className="sticky top-0 bg-white/95 backdrop-blur-sm border-b border-gray-200 px-8 py-5 flex items-center justify-between z-10">
          <div>
            <h2 className="text-2xl font-bold text-gray-900 tracking-tight">创建新题目</h2>
            <p className="text-sm text-gray-500 mt-0.5">为当前课堂添加互动检测内容</p>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            ...
            >
              ...
              <option value="text_input">文本回答</option>
              <option value="number_input">数值滑块</option>
